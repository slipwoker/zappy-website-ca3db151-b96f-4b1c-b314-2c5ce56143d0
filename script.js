            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(() => {
                        ...
                        successMessage.style.cssText = 'background: #27ae60; color: white; padding: 1rem; border-radius: 4px; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ca3db151-b96f-4b1c-b314-2c5ce56143d0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ca3db151-b96f-4b1c-b314-2c5ce56143d0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ca3db151-b96f-4b1c-b314-2c5ce56143d0';
